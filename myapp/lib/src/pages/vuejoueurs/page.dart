...
class PageVuejoueurs extends StatefulWidget {
  const PageVuejoueurs({
    Key? key,
    this.imageJoueur =
  ...
  @override
  _StateVuejoueurs createState() => _StateVuejoueurs();
}

class _StateVuejoueurs extends AuthState<PageVuejoueurs>
